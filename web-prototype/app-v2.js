 ...
 *
 * Features:
 *  - Theme-Umschaltung (Pink/Blau) über Settings (persistent)
 *  - Sprache DE/EN (wichtige Texte per i18n)
 *  - Projektliste (Workspace) mit Spielzeug-Typ (LEGO/Playmobil/Barbie)
 *  - Kamera-Ansicht mit Frames, Ghosting-Overlay
 *  - Player/Editor: Play/Pause, Vor/Zurück, FPS, Positions-Slider
...
(function () {
  ...
  function renderProjects() {
    ...
    // Hinweis-Text ausblenden, wenn Projekte existieren
